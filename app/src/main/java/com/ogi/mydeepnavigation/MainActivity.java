...
public class MainActivity extends AppCompatActivity implements View.OnClickListener, AsyncCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button btnShowDetailMessage = findViewById(R.id.btn_open_detail);
        btnShowDetailMessage.setOnClickListener(this);
    ...
    public void postAsync() {
        showNotification(MainActivity.this, "Hi, how are you?", "Do you have any plan? Let's hangout", 110);
    }
